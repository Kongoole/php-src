...
#define ZEND_SET_CALL_INFO(call, object, info)                                                               \
	do                                                                                                       \
	{                                                                                                        \
...
#define ZEND_PASS_TWO_UPDATE_CONSTANT(op_array, node)          \
	do                                                         \
	{                                                          \
...
#define ZEND_PASS_TWO_UNDO_CONSTANT(op_array, node)         \
	do                                                      \
	{                                                       \
...
#define EX_LOAD_LITERALS(op_array)           \
	do                                       \
	{                                        \
...
#define EX_LOAD_RUN_TIME_CACHE(op_array)                 \
	do                                                   \
	{                                                    \
